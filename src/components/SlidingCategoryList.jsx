                          ...
                          <div
                            ...
                            className={`
                              ...
                              ${activeCategory?.id === category.id 
                                ? 'bg-blue-300 shadow-md border-purple-300' 
                                : 'bg-white hover:bg-orange-200 hover:shadow-sm hover:-translate-y-[2px]'}
                              ...
                              <div className="flex items-center gap-2">
                                <ChevronRight
                                  className={`h-4 w-4 transition-transform duration-200
                                    ${activeCategory?.id === category.id ? 'rotate-90 text-purple-500' : ''}`}
                                />
